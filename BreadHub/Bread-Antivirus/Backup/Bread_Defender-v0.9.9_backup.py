...
class BreadDefender:
    def __init__(self, root):
        self.root = root
        self.root.title("Bread Defender - Anti-Virus Protection")
    ...
    def create_widgets(self):
        ...
        license_text = ("Bread Defender v0.9.8 by Доктор Bread\n"
                        "Copyright (c) 2026 Доктор Bread - Bread Defender. All Rights Reserved.\n"
